...
movie1 = Movie.create(name: 'DDLJ', language: 'Hindi', duration: '3.2', rating: '9', release_date: "Thu Feb 11 1992 12:12:12 GMT+0530 (IST)", theatre_id: theatre['_id'])
movie2 = Movie.create(name: 'Interstellar', language: 'English', duration: '3', rating: '9', release_date: "Fri Feb 11 2014 12:00:00 GMT+0530 (IST)", theatre_id: theatre['_id'])
...
show1 = Show.create(starttime: 'Thu Feb 11 1992 12:12:12 GMT+0530 (IST)', endtime: 'Thu Feb 11 1992 15:12:12 GMT+0530 (IST)', screen_id: screen1['_id'], movie_id: movie1['_id'])
...
#booking fields(ticket_numbres, number_of_tickets, amount, payment_mode, card_type, card_number, user_id, movie_id)
booking = Booking.create(ticket_numbres: '1, 2, 3, 4', number_of_tickets: 4, amount: 500, payment_mode: 'Online', card_type: 'Debit Card', card_number: '123456789', user_id: user1['_id'], movie_id: movie1['_id'])

#ticket fields(number, type, price, booking_id, seat_id, movie_id)
ticket1 = Ticket.create(number: 'Ticket A', type: "Silver", price: '100', booking_id: booking['_id'], seat_id: seat1['_id'], movie_id: movie1['_id'])
ticket2 = Ticket.create(number: 'Ticket B', type: "Gold", price: '120', booking_id: booking['_id'], seat_id: seat1['_id'], movie_id: movie1['_id'])
ticket2 = Ticket.create(number: 'Ticket C', type: "Platinum", price: '140', booking_id: booking['_id'], seat_id: seat1['_id'], movie_id: movie2['_id'])
